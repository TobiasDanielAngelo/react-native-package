...
export function MyGenericForm({ item, setVisible, fetchFcn, fields, objectName, store, dateFields = [], datetimeFields = [], timeFields = [], }) {
    ...
    return (_jsx(View, { style: { alignItems: "center" }, children: _jsx(MyForm, { fields: fields, title: title, details: details, setDetails: setDetails, onPressSubmit: item?.id ? onPressEdit : onPressCreate, onPressSubmitAdd: onPressCreateAdd, hasDelete: !!item?.id, onDelete: onPressDelete, msg: msg, isLoading: isLoading }) }));
}
